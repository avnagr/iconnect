          ...
          <div class="navbar-header">
              ...
              <div id="main-nav" class="collapse navbar-collapse">
                <ul class="nav navbar-nav" id="mainNav">
                  ...
                  <?php
                    echo '<li><a href="blog.php?post='."Educational".'"><font size="3px" >'."Blog".'</font></a></li>';
                  ?>
...
<!--Top Header End-->
 ...
 <!--Breadcrumbs-->
        ...
        <ul class="breadcrumb">
            <li><a href="index.php">Home</a></li>
             <li><?php
                   echo '<li><a href="blog.php?post='."Education".'"><font size="3px" >'."Blog".'</font></a></li>';
                  ?></li>
    ...
    <div class="col-md-4 top3">
                ...
                <div class="well">
                    ...
                    <div class="input-group">
                        Register to our portal for writing your own blog.You can also write comment on others blog.
...
<!-- END of PHP Code for priting the Popular post value --> 
     ...
     <div class="col-lg-12 top2 bottom2">
      <div class="text-center"><font color="Maroon">Copy Right &copy; BLOG-NITC</font> </div>
    </div>
</footer><!--Footer End-->
</div>
<!--Main Body End-->
