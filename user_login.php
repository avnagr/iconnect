...
<!-- PHP CODE FOR SIGNUP OF NEW USER -->
		<?php
         if(isset($_POST['sign_up']))
		 {
			 ...
			 $email_id=$_POST['email_id'];
			 $password=$_POST['password'];		  
		     $sql="insert into user(first_name,last_name,dob,gender,email_id,password,contact) values('$first_name',
			 '$last_name','$gender','$email_id','$password')";
			 if(mysqli_query($conn,$sql))
			 {
				 echo "<font color='#283747' size='5px'>Congratulation....Registration Successfull</font>";
			 }
			 else
			 {
